...
{
    internal sealed class CutOffTreeSolution
    {
        private readonly int[][] dirs = { new int[] { -1, 0 }, new int[] { 1, 0 }, new int[] { 0, -1 }, new int[] { 0, 1 } };
        ...
        private int BFS(IList<IList<int>> forest, int sx, int sy, int tx, int ty)
        {
            if (sx == tx && sy == ty)
            {
                return 0;
